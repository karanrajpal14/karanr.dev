...
## Git
You will need to have Git installed for the commands mentioned below to work. Please install the right version for your system from [here](https://git-scm.com/download/win)
